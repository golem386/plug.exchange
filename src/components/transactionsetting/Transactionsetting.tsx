    ...
    return (
        <MainDiv>
            <SwapDiv>
                ...
                <img src={close} onClick={() => { onModel('Swep') }} />
            </SwapDiv>
            <Slippage>
            ...
            <FlexViewJustyfy>
                ...
                {
                    Slider === false ? <TimeText>Instant (102.73 - 140.28 GWEI)<DownAeroIcon src={DownAero} onClick={() => { setSlider(!Slider) }} /></TimeText> : <TimeTextPink>Instant (102.73 - 140.28 GWEI)<DownAeroIcon onClick={() => { setSlider(!Slider) }} src={TopAero} /></TimeTextPink>
                }
            </FlexViewJustyfy>
            {
                Slider ? <><MainDivs>
